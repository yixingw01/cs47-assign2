...
import { Platform, StyleSheet, Text, View, StatusBar, Image, Button, TouchableOpacity} from 'react-native';
...
export default function App() {
  ...
  //       <Tab.Navigator
  //         <Image 
  //         source={require(Icons.discoverLegacy.light)}
  //         />
  //         <Image 
  //         source={require(Icons.heart.light)}
  //         />
  //         <Image 
  //         source={require(Icons.messages.light)}
  //         />
  //     )
  //     </View>
  // }
